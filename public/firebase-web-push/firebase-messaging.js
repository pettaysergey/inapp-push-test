  ...
  try {
    !function () {
              ...
              for (; a; )
                try {
                  if (
                    ((i = 1),
                    o &&
                      (s = 2 & t[0] ? o.return : t[0] ? o.throw || ((s = o.return) && s.call(o), 0) : o.next) &&
                      !(s = s.call(o, t[1])).done)
                  )
                    return s;
      ...
      m(C, '_index', ['name', 'keyPath', 'multiEntry', 'unique']),
        k(C, '_index', IDBIndex, ['get', 'getKey', 'getAll', 'getAllKeys', 'count']),
      ...
      function ne() {
        return (
          !te &&
            ...
            ((te = new BroadcastChannel('[Firebase] FID Change')).onmessage = function (e) {
                      ...
                      (e = (function (e, t) {
                        {
                          ...
                          (t = { fid: t.fid, registrationStatus: 1, registrationTime: Date.now() }),
                            (e = (function (r, i) {
                              return d(this, void 0, void 0, function () {
                                var t, n;
                                return h(this, function (e) {
                                  switch (e.label) {
                                                ...
                                                switch (e.label) {
                                                  case 0:
                                                    return (
                                                      (t = V(s)),
                                                      (n = W(s)),
                                                      (o = { fid: a, authVersion: N, appId: s.appId, sdkVersion: x }),
                                    ...
                                    case 3:
                                      return e.sent(), [3, 6];
                                    case 4:
                                      return [4, le(r, { fid: i.fid, registrationStatus: 0 })];
                                    case 5:
                                      e.sent(), (e.label = 6);
                                    case 6:
                                      throw n;
            ...
            switch (e.label) {
              case 0:
                return (
                  ...
                  (n = H(a, s)),
                  (o = u.getImmediate({ optional: !0 })) && n.append('x-firebase-client', o.getPlatformInfoString()),
                  ...
                  return [
                    ...
                    pe(i.appConfig, function (e) {
                      ...
                      if (
                        ...
                        n =
                          ((t = e), (n = { requestStatus: 1, requestTime: Date.now() }), p(p({}, t), { authToken: n }));
                        return (
                          (r = (function (i, o) {
                            return d(this, void 0, void 0, function () {
                              var t, n, r;
                              return h(this, function (e) {
                                switch (e.label) {
                                  ...
                                  case 1:
                                    return (t = e.sent()), (r = p(p({}, o), { authToken: t })), [4, le(i.appConfig, r)];
                                  case 2:
                                    return e.sent(), [2, t];
                                  case 3:
                                    return !L((n = e.sent())) ||
                                  ...
                                  case 5:
                                    return (
                                      (r = p(p({}, o), { authToken: { requestStatus: 0 } })), [4, le(i.appConfig, r)]
                                    );
                                  case 6:
                                    e.sent(), (e.label = 7);
                                  case 7:
                      ...
                      switch (e.label) {
                        ...
                        case 1:
                          return (
                            ...
                            (t.registrationPromise || be(r)).catch(console.error),
                            [2, n.fid]
                          );
                      }
                    });
      ...
      var Ce,
        R =
          ...
          (R['permission-default'] = 'The notification permission was not granted and dismissed instead.'),
          (R['permission-blocked'] = 'The notification permission was not granted and blocked instead.'),
          (R['unsupported-browser'] = "This browser doesn't support the API's required to use the firebase SDK."),
          (R['failed-service-worker-registration'] =
            'We are unable to register the default service worker. {$browserErrorMessage}'),
          (R['token-subscribe-failed'] = 'A problem occurred while subscribing the user to FCM: {$errorInfo}'),
          (R['token-subscribe-no-token'] = 'FCM returned no token when subscribing the user to push.'),
          (R['token-unsubscribe-failed'] = 'A problem occurred while unsubscribing the user from FCM: {$errorInfo}'),
          (R['token-update-failed'] = 'A problem occurred while updating the user from FCM: {$errorInfo}'),
          ...
          (R['invalid-sw-registration'] = 'The input to useServiceWorker() must be a ServiceWorkerRegistration.'),
          (R['invalid-bg-handler'] = 'The input to setBackgroundMessageHandler() must be a function.'),
          (R['invalid-vapid-key'] = 'The public VAPID key must be a string.'),
          (R['use-vapid-key-after-get-token'] =
            'The usePublicVapidKey() method may only be called once and must be called before calling getToken() to ensure your VAPID key is used.'),
          R),
        Te = new l('messaging', 'Messaging', R),
                          ...
                          switch (e.label) {
                            case 0:
                              return i.oldVersion < 2
                                ...
                                ? [4, (r = i.transaction.objectStore(Ke)).index('fcmSenderId').get(s)]
                                : [2];
                            case 1:
                            ...
                            case 2:
                              ...
                              } else (3 === i.oldVersion || 4 === i.oldVersion) && (o = { token: (n = t).fcmToken, createTime: n.createTime, subscriptionOptions: { auth: Oe(n.auth), p256dh: Oe(n.p256dh), endpoint: n.endpoint, swScope: n.swScope, vapidKey: Oe(n.vapidKey) } });
                              return [2];
                          }
                        });
                      });
          ...
          return h(this, function (e) {
            switch (e.label) {
              case 0:
                return [4, He(r)];
              case 1:
                (t = e.sent()), (t = { method: 'DELETE', headers: t }), (e.label = 2);
              case 2:
              ...
              case 4:
                if ((t = e.sent()).error)
                  throw ((n = t.error.message), Te.create('token-unsubscribe-failed', { errorInfo: n }));
                return [3, 6];
              case 5:
                throw ((n = e.sent()), Te.create('token-unsubscribe-failed', { errorInfo: n }));
              case 6:
                return [2];
            }
          });
              ...
              case 8:
                return Date.now() >= s.createTime + 6048e5
                  ? [
                        ...
                        return d(this, void 0, void 0, function () {
                          ...
                          return h(this, function (e) {
                            switch (e.label) {
                                      ...
                                      return d(this, void 0, void 0, function () {
                                        ...
                                        return h(this, function (e) {
                                          switch (e.label) {
                                            ...
                                            case 1:
                                              (t = e.sent()),
                                                (n = $e(s.subscriptionOptions)),
                                                (n = { method: 'PATCH', headers: t, body: JSON.stringify(n) }),
                                                (e.label = 2);
                                            case 2:
                                              return (
                                                e.trys.push([2, 5, , 6]), [4, fetch(We(o.appConfig) + '/' + s.token, n)]
                                              );
                                            case 3:
                                              return [4, e.sent().json()];
                                            case 4:
                                            ...
                                            case 5:
                                              throw (
                                                ((i = e.sent()), Te.create('token-update-failed', { errorInfo: i }))
                                              );
                                            case 6:
                                              if (r.error)
                                                throw (
                                                  ((i = r.error.message),
                                                  Te.create('token-update-failed', { errorInfo: i }))
                                                );
                              ...
                              case 1:
                                return (
                                  (t = e.sent()), (n = p(p({}, i), { token: t, createTime: Date.now() })), [4, Ve(o, n)]
                                );
                              case 2:
                                return e.sent(), [2, t];
                              case 3:
                      ...
                      })({ token: s.token, createTime: Date.now(), subscriptionOptions: a }, c, l),
                    ]
                  : [2, s.token];
              case 9:
                return [2];
                      ...
                      return d(this, void 0, void 0, function () {
                        ...
                        return h(this, function (e) {
                          switch (e.label) {
                            ...
                            case 1:
                              return (
                                (n = e.sent()), [4, (n = n.transaction(qe, 'readwrite')).objectStore(qe).delete(t)]
                              );
                            case 2:
                              return e.sent(), [4, n.complete];
                            case 3:
        ...
        return d(this, void 0, void 0, function () {
          ...
          return h(this, function (e) {
            switch (e.label) {
                      ...
                      return h(this, function (e) {
                        switch (e.label) {
                          ...
                          case 1:
                            (t = e.sent()),
                              (n = $e(s)),
                              (n = { method: 'POST', headers: t, body: JSON.stringify(n) }),
                              (e.label = 2);
                          case 2:
                          ...
                          case 4:
                            return (r = e.sent()), [3, 6];
                          case 5:
                            throw ((i = e.sent()), Te.create('token-subscribe-failed', { errorInfo: i }));
                          case 6:
                            if (r.error)
                              throw ((i = r.error.message), Te.create('token-subscribe-failed', { errorInfo: i }));
              ...
              case 1:
                return (
                  (t = e.sent()), (t = { token: t, createTime: Date.now(), subscriptionOptions: r }), [4, Ve(n, t)]
                );
              case 2:
      ...
      var Xe =
        ...
        (et.prototype.setBackgroundMessageHandler = function (e) {
          if (((this.isOnBackgroundMessageUsed = !1), !e || 'function' != typeof e))
                ...
                case 1:
                  (t = e.sent()),
                    (this.vapidKey =
                      null !==
                        (n =
                          null === (n = null == t ? void 0 : t.subscriptionOptions) || void 0 === n
                            ? void 0
                            : n.vapidKey) && void 0 !== n
                        ? n
                        : _e),
                    ...
                    : ((o = !1),
                      s.notification
                        ? [
                            ...
                            })((((r = p({}, (t = s).notification)).data = (((n = {})[De] = t), n)), r)),
                          ]
                        : [3, 3]);
                case 2:
                  ...
                  return (
                    ...
                    [
                      ...
                      Ge(
                        ...
                        null !==
                          (r =
                            null === (r = null == t ? void 0 : t.subscriptionOptions) || void 0 === r
                              ? void 0
                              : r.vapidKey) && void 0 !== r
                          ? r
                          : _e,
          ...
          return d(this, void 0, void 0, function () {
            ...
            return h(this, function (e) {
              switch (e.label) {
                case 0:
                  return (t =
                    null === (a = null === (a = s.notification) || void 0 === a ? void 0 : a.data) || void 0 === a
                      ? void 0
                      : a[De])
                    ? s.action
                      ? [2]
                      : (s.stopImmediatePropagation(),
                        ...
                        (n = (function (e) {
                          var t,
                            n =
                              null !== (t = null === (t = e.fcmOptions) || void 0 === t ? void 0 : t.link) &&
                              void 0 !== t
                                ? t
                ...
                case 6:
                  return o
                    ? ((t.messageType = Ce.NOTIFICATION_CLICKED), (t.isFirebaseMessaging = !0), [2, o.postMessage(t)])
                    : [2];
              }
            });
          });
                  ...
                  return (n = i.data).isFirebaseMessaging
                    ? (this.onMessageCallback &&
                        ...
                        ('function' == typeof this.onMessageCallback
                          ? this.onMessageCallback(
                              (delete (t = Object.assign({}, n)).messageType, delete t.isFirebaseMessaging, t),
                            )
                          : this.onMessageCallback.next(Object.assign({}, n))),
                      Ze((r = n.data)) && '1' === r['google.c.a.e'] ? [4, this.logEvent(n.messageType, r)] : [3, 2])
                    : [2];
                case 1:
                  e.sent(), (e.label = 2);
                case 2:
            ...
            return h(this, function (e) {
              switch (e.label) {
                ...
                case 2:
                  throw (
                    ((t = e.sent()),
                    Te.create('failed-service-worker-registration', { browserErrorMessage: t.message }))
                  );
                case 3:
                  return [2];
              }
      ...
      t.default.INTERNAL.registerComponent(
        new g(
          ...
          function (e) {
            var t = e.getProvider('app').getImmediate(),
              e = {
                ...
                appConfig: (function (e) {
                  ...
                  try {
                    for (
                      var i = c(['projectId', 'apiKey', 'appId', 'messagingSenderId']), o = i.next();
                      !o.done;
                      o = i.next()
                    ) {
                      var s = o.value;
            ...
            if (!ot()) throw Te.create('unsupported-browser');
    ...
    throw (
      (console.error(e), new Error('Cannot instantiate firebase-messaging.js - be sure to load firebase-app.js first.'))
    );
  }
});
