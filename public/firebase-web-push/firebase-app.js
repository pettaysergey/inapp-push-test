!(function (e, t) {
          ...
          for (; s; )
            try {
              if (
                ((i = 1),
                o &&
                  (a = 2 & t[0] ? o.return : t[0] ? o.throw || ((a = o.return) && a.call(o), 0) : o.next) &&
                  !(a = a.call(o, t[1])).done)
              )
                return a;
  ...
  function f(e, t) {
    ...
    for (var n in t) t.hasOwnProperty(n) && '__proto__' !== n && (e[n] = f(e[n], t[n]));
    return e;
  }
  var o =
    ...
    (w.prototype.subscribe = function (e, t, n) {
      ...
      void 0 ===
        (r = (function (e, t) {
          ...
          ? e
          : { next: e, error: t, complete: n }).next && (r.next = I),
  ...
  var _ = '[DEFAULT]',
    N =
      ...
      (L.prototype.getImmediate = function (e) {
        var t = i({ identifier: _, optional: !1 }, e),
          e = t.identifier,
          t = t.optional,
      ...
      (L.prototype.clearInstance = function (e) {
        void 0 === e && (e = _), this.instancesDeferred.delete(e), this.instances.delete(e);
      }),
      ...
      (L.prototype.isInitialized = function (e) {
        return void 0 === e && (e = _), this.instances.has(e);
      }),
      (L.prototype.initialize = function (e) {
        ...
        var o = this.getOrInitializeService({ instanceIdentifier: i, options: e });
        try {
          for (var a = u(this.instancesDeferred.entries()), s = a.next(); !s.done; s = a.next()) {
            var c = p(s.value, 2),
              l = c[0],
              c = c[1];
            i === this.normalizeInstanceIdentifier(l) && c.resolve(o);
          }
        } catch (e) {
          t = { error: e };
        } finally {
  ...
  var D = { debug: R.DEBUG, verbose: R.VERBOSE, info: R.INFO, warn: R.WARN, error: R.ERROR, silent: R.SILENT },
    j = R.INFO,
    z =
      (((x = {})[R.DEBUG] = 'log'),
      (x[R.VERBOSE] = 'log'),
    ...
    F =
      ...
      k);
  function k(e) {
    (this.name = e), (this._logLevel = j), (this._logHandler = P), (this._userLogHandler = null), A.push(this);
  }
  function T(t) {
            ...
            null === a
              ...
              : function (e, t) {
                  ...
                  t >= (null != o ? o : e.logLevel) &&
                    a({ level: R[t].toLowerCase(), message: i, args: n, type: e.name });
                });
      })(n[e]);
  }
  var x =
      (((x = {})['no-app'] = "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()"),
      ...
      (x['invalid-app-argument'] = 'firebase.{$appName}() takes either no argument or a Firebase App instance.'),
      (x['invalid-log-argument'] = 'First argument to `onLog` must be null or a function.'),
      x),
    B = new d('app', 'Firebase', x),
    V = '@firebase/app',
    M = '[DEFAULT]',
    U =
      (((x = {})[V] = 'fire-core'),
    ...
    G =
      ...
      ($.prototype._getService = function (e, t) {
        return (
          void 0 === t && (t = M), this.checkDestroyed_(), this.container.getProvider(e).getImmediate({ identifier: t })
        );
      }),
      ...
      ($.prototype.checkDestroyed_ = function () {
        if (this.isDeleted_) throw B.create('app-deleted', { appName: this.name_ });
      }),
      $);
  function $(e, t, n) {
    var r = this;
  ...
  function J(a) {
    var s = {},
      ...
      l = {
        ...
        initializeApp: function (e, t) {
          ...
          t = n.name;
          if ('string' != typeof t || !t) throw B.create('bad-app-name', { appName: String(t) });
          if (y(s, t)) throw B.create('duplicate-app', { appName: t });
          n = new a(e, n, l);
          return (s[t] = n);
        },
        app: u,
    ...
    function u(e) {
      if (!y(s, (e = e || M))) throw B.create('no-app', { appName: e });
      return s[e];
    }
    function o(n) {
      var e,
      ...
      if (c.has(r))
        return (
          W.debug('There were multiple attempts to register component ' + r + '.'), 'PUBLIC' === n.type ? l[r] : null
        );
      c.set(r, n),
        'PUBLIC' === n.type &&
          ((e = function (e) {
            if ('function' != typeof (e = void 0 === e ? u() : e)[r])
              throw B.create('invalid-app-argument', { appName: r });
            return e[r]();
          }),
          void 0 !== n.serviceProps && f(e, n.serviceProps),
          (l[r] = e),
  ...
  (q = ee).INTERNAL.registerComponent(
    ...
    q.registerVersion(V, '0.6.20', Q),
    q.registerVersion('fire-js', '');
  return ee.registerVersion('firebase', '8.4.0', 'app'), ee;
});
